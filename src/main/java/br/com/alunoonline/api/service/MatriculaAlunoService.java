...
import br.com.alunoonline.api.dtos.DisciplinaAlunoResponseDTO;
...
public class MatriculaAlunoService {
    ...
    public void atualizarNotas(Long matriculaAlunoId, AtualizarNotasRequestDTO atualizarNotasRequestDTO) {
        MatriculaAluno matriculaAluno = buscarMatriculaOuLançarExecao(matriculaAlunoId);
    ...
    public HistoricoAlunoResponseDTO emitirHistorico(Long alunoId){
        ...
        List<DisciplinaAlunoResponseDTO> disciplinas = matriculaAlunos.stream()
                .map(this::mapearParaDisciplinasAlunosResponseDTO)
                .toList();
    ...
    private MatriculaAluno buscarMatriculaOuLançarExecao(Long matriculaAlunoId) {
        return matriculaAlunoRepository.findById(matriculaAlunoId).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "matricula do aluno não encontrada"));
    }
    ...
    private DisciplinaAlunoResponseDTO mapearParaDisciplinasAlunosResponseDTO(MatriculaAluno matriculaAluno){
        DisciplinaAlunoResponseDTO response = new DisciplinaAlunoResponseDTO();
